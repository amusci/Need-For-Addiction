...
public class RunApp extends Panel {		
	...
	public static void main(String[] strings) {
		...
		System.out.println("Need For Addiction Console");// Change this to the message of your preference
		try {
	...
	public static void startup() {
		frame = new Frame("Need For Addiction");// Change this to the name of your preference
