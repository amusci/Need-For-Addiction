...
public class GameSparker extends Applet implements Runnable {
    ...
    public static final String carModels[] = {
            "2000tornados", "formula7", "ranger", "lescrab", "nimi", "maxrevenge", "leadoxide", "ae86", "drifter",
...
nob++;
        ...
        if(checkpoints.stage == 2 || checkpoints.stage == 16)
            medium.lightn = 0;
        else
            medium.lightn = -1;
            ...
            if (xtgraphics.fase == 0) {
                ...
                if (xtgraphics.starcnt == 0) {
                    ...
                    do {
                        ...
                        do {
                            if(j14 != l12&& !ghostmode[j14] && !ghostmode[l12]) {//&& !ghostmode[j14] && !ghostmode[l12]
