            ...
            if (madness.mtouch) {
                if (stcnt > statusque) {
                    ...
                    if (cntrn == 0) {
                        ...
                        if (attack != 0) {
                            turntyp = 2;
                            if (checkpoints.stage == 11 || checkpoints.stage == 13
                        ...
                        if (checkpoints.stage == 3 ||checkpoints.stage == 4 ||checkpoints.stage == 6 || checkpoints.stage == 7 
                    ...
                    if (attack == 0) {
                        ...
                        if (checkpoints.stage == 5 && bulistc) {
                            j2 = 30;
                        }
                        if (checkpoints.stage == 7) {
                            j2 = 0;
